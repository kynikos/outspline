...
class Rule():
    ...
    def apply_rule(self, filename, id_):
        months = self.monthsw.get_months()
        ...
        try:
            ...
            label = self._make_label(months, rstartd, rstartH, rstartM, rendH,
    ...
    @staticmethod
    def _make_label(months, rstartd, rstartH, rstartM, rendH, rendM, ralarmH,
