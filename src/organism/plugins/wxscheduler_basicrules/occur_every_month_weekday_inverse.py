...
class Rule():
    ...
    def _create_widgets_start(self):
        ...
        self.startw = widgets.MonthInverseWeekdayHourCtrl(self.mpanel)
    ...
    def apply_rule(self, filename, id_):
        ...
        try:
            ruled = organizer_basicrules_api.make_occur_monthly_weekday_inverse_rule(
    ...
    def _make_label(rstartin, rstartA, rstartH, rstartM, rendH, rendM, ralarmH,
        ...
        label = 'Occur on the {} {} of every month at {}:{}'.format(
              widgets.MonthInverseWeekdayHourCtrl._compute_weekday_number_label(
                                                             rstartin), rstartA,
    ...
    def create_random_rule():
        ...
        return organizer_basicrules_api.make_occur_monthly_weekday_inverse_rule(
