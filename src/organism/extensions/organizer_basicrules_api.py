...
from organizer_basicrules import occur_once, occur_every_day, except_once
...
def make_occur_every_day_rule(rstart, rend, ralarm, guiconfig):
    return occur_every_day.make_rule(rstart, rend, ralarm, guiconfig)
