...
from outspline.static.wxclasses.time import (HourCtrl, MonthDayHourSafeCtrl,
                                                                  TimeSpanCtrl)
...
class Rule():
    ...
    def _create_widgets_start(self):
        ...
        self.startw = MonthDayHourSafeCtrl(self.mpanel)
    ...
    def _make_label(rstartd, rstartH, rstartM, rendH, rendM, ralarmH, ralarmM,
        ...
        label = 'Occur on the {} day of every month at {}:{}'.format(
                              MonthDayHourSafeCtrl._compute_day_label(rstartd),
