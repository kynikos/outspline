...
class Rule(object):
    ...
    def apply_rule(self, filename, id_):
        ...
        try:
            ...
            label = self._make_label(rstartin, rstartA, rstartH, rstartM,
                rendH, rendM, ralarmH, ralarmM, rendn, rendu, ralarmn, ralarmu,
    ...
    def insert_rule(cls, filename, id_, rule, rulev):
        ...
        label = cls._make_label(values['start_weekday_number'],
