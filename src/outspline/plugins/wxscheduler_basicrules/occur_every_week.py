...
from outspline.static.wxclasses.time import (HourCtrl, WeekDayHourCtrl,
                                                                  TimeSpanCtrl)
...
class Rule():
    ...
    def _create_widgets_start(self):
        ...
        self.startw = WeekDayHourCtrl(self.mpanel)
    ...
    def _compute_values(cls, rule):
        ...
        values.update({
            'rstartA': WeekDayHourCtrl._compute_widget_day(currw),
