...
class Rule(object):
    ...
    def apply_rule(self, filename, id_):
        ...
        rwstart = values['start_relative_week_time']
        ...
        refstart = int(_time.time()) // 604800 * 604800 + rwstart
    ...
    def _compute_values(cls, standard, rule):
        ...
        if not rule:
            ...
            currw = _datetime.datetime.fromtimestamp(values['reference_min'] +
                                    values['start_relative_time']).weekday()
    ...
    def _make_label(rstartA, rstartH, rstartM, rendH, rendM, ralarmH, ralarmM,
        ...
        label = 'Occur every {} at {}:{} ({})'.format(rstartA,
